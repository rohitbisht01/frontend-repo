...
const MediumSelectionText = () => {
  ...
  2.38,10 2.38,10.03C2.38,12.11 3.86,13.85 5.82,14.24C5.46,14.34 5.08,14.394.69,14.39C4.42,14.39 4.15,14.36 3.89,14.31C4.43,16 6,17.26
  7.89,17.29C6.43,18.45 4.58,19.13 2.56,19.13C2.22,19.13 1.88,19.11
  1.54,19.07C3.44,20.29 5.7,21 8.12,21C16,21 20.33,14.46 20.33,8.79C20.33,8.6
  ...
  18.5,1.15M10.3,8.5L4.34,14.46C3.56,15.24 3.56,16.5 4.36,17.31C3.14,18.54
  ...
  10,20.12L15.95,14.16"
      ...
      <div ref={ref}>
        ...
        classical Latin literature from 45 BC, making it over 2000years old.
...
export default MediumSelectionText;
