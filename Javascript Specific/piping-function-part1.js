  ...
  return function (...args) {
    ...
    for (let key in obj) {
      ...
      if (typeof val === "function") {
        // pass the args to the function and store the result on the same key
        obj[key] = val(...args);
      } else {
        // else recursively call the same function if it is nested object it will be further processed
